...
const Footer = () => {
    return (
        <div className="mt-16 border-t-2 pt-8 border-black">
            <div className="w-full flex">
                <div className="w-1/2">
                    <div className="ml-10 w-4/6 border px-8 py-6">Sign Up</div>
                    <div className="w-full flex justify-evenly mt-8">
                        <div className="w-3/6">
                            <input className="px-4 py-2 border w-full " type="Email" placeholder="Email"/>
                        </div>
                        <div className="border rounded-full w-2/6 hover:cursor-pointer">
                            <a className="p-4" href="#">Button</a>
                        </div>
                    </div>
                </div>
                <div className="w-1/2">
                    <div className="mx-16 grid grid-cols-2 gap-20 sm:grid-cols-3 md:grid-cols-3 xl:grid-cols-3 xl:grid-cols-3">
